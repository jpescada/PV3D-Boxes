package org.papervision3d.view 
{
	...
	public class Viewport3D extends Sprite implements IViewport3D
	{
		...
		/**
		 *  Initial resize to avoid scaling all 3d objects to stage dimensions
		 *  @author		Joao Pescada | VIEW. [joao.pescada@view.pt | (+351) 214818500 | www.view.pt]
		 */
		protected function initialResize():void
		{
			//width
			var minWidth:Number = 960;
			var iWidth:Number = minWidth;//stage.stageWidth;
			...
			cullingRectangle.width = iWidth;
			
			sizeRectangle.width = iWidth;
			if(_autoClipping)
			{
			...
			var iHeight:Number = minHeight;//stage.stageHeight;
			...
			cullingRectangle.height = iHeight;
			
			sizeRectangle.height = iHeight;
			if(_autoClipping)
			{
				scrollRect = sizeRectangle;
			}
